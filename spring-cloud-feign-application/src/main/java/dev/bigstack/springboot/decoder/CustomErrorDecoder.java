package dev.bigstack.springboot.decoder;
...
public class CustomErrorDecoder implements ErrorDecoder {
    ...
    public Exception decode(String methodKey, Response response) {
        ...
        GlobalExceptionObject globalException = extractBankingCoreGlobalException(response);
    ...
    private GlobalExceptionObject extractBankingCoreGlobalException(Response response) {
    	GlobalExceptionObject exceptionMessage = null;
        Reader reader = null;
